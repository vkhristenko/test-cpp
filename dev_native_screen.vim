...
set runtimepath+=~/.vim/bundle/vim-opencl
set runtimepath+=~/.vim/bundle/verilog_systemverilog.vim
set runtimepath+=~/.vim/bundle/fzf.vim
set runtimepath+=~/.vim/bundle/vim-terraform
...
set runtimepath+=~/.vim/bundle/vim-scala/after
set runtimepath+=~/.vim/bundle/syntastic/after
set runtimepath+=~/.vim/bundle/vim-colors-solarized/after
set runtimepath+=~/.vim/bundle/vim-elixir/after
set runtimepath+=~/.vim/bundle/rust.vim/after
...
set runtimepath+=~/.vim/bundle/vim-opencl/after
set runtimepath+=~/.vim/bundle/verilog_systemverilog.vim/after
set runtimepath+=~/.vim/bundle/fzf.vim/after
set runtimepath+=~/.vim/bundle/vim-terraform/after
set runtimepath+=~/.vim/bundle/YouCompleteMe/after
set runtimepath+=~/.vim/bundle/vim-qml/after
set shiftwidth=4
...
exe 'vert 3resize ' . ((&columns * 59 + 90) / 181)
argglobal
enew
setlocal keymap=
setlocal noarabic
